/**
 * @fileoverview `useIsomorphicLayoutEffect` hook.
 */
...
/**
 * `useIsomorphicLayoutEffect` is a React hook that provides the behavior of `useLayoutEffect`
 * without triggering warnings during server-side rendering.
 ...
 * @example
 * ```tsx
 * import { useIsomorphicLayoutEffect } from '@lumir/react-kit/hooks';
 *
 * function Component() {
