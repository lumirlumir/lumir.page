...
### 2-1. 물리적 태그와 논리적 태그 {#2-1-physical-tags-and-logical-tags}

#### 2-1-1. 물리적 태그 {#2-1-1-physical-tags}
...
#### 2-1-2. 논리적 태그(시멘틱 태그, Semantic Tag) {#2-1-2-logical-tags-semantic-tags}
