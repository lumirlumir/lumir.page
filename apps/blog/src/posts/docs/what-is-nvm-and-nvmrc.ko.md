...
### 2-1. 작성 방법 {#2-1-how-to-write-nvmrc}
...
### 2-2. 사용 방법 {#2-2-how-to-use-nvmrc}

주로, 프로젝트를 Clone 하였을 때 사용할 수 있는 방법이다.

#### 2-2-1. 해당 버전이 설치 되어있지 않은 경우 {#2-2-1-when-version-is-not-installed}
...
#### 2-2-2. 해당 버전으로 변경 {#2-2-2-switch-to-version}
