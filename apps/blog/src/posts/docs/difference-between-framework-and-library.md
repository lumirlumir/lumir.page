...
### 1-1. 특징 {#1-1-framework-characteristics}

- 특정 개념들의 추상화를 제공하는 여러 클래스나 컴포넌트들로 구성된다.
- 컴포넌트들은 재사용이 가능하다.
- 높은 수준에서 패턴들을 조작화 할 수 있다.

### 1-2. 장점 {#1-2-framework-advantages}
...
### 1-3. 단점 {#1-3-framework-disadvantages}

- 의존성이 높아지면, 직접 개발이 어려워져 개발 능력이 다소 떨어질 수 있다.
- 학습에 오랜 시간이 걸린다.

### 1-4. 예시 {#1-4-framework-examples}
...
### 2-1. 예시 {#2-1-library-examples}

- ***Python***: ***Tensorflow***, ***Pandas***, ***Beautifulsoup***, ***pip***로 설치한 모듈
- ***JavaScript***(***Node.js***): ***jQuery***, ***React***, ***Redux***, ***Three.js***, ***npm***으로 설치한 모듈
- ***C++***: 표준 템플릿 라이브러리(***STL***)

### 2-2. ***React.js***는 프레임워크가 아닌가? {#2-2-is-react-js-not-a-framework}

![React 사용자 인터페이스를 만들기 위한 JavaScript 라이브러리](/apps/blog/public/images/posts/difference-between-framework-and-library/1.webp?raw=true)
...
### 2-3. 그럼 ***Express.js***는? {#2-3-what-about-express-js}

![Express Node.js를 위한 빠르고 개방적인 간결한 웹 프레임워크](/apps/blog/public/images/posts/difference-between-framework-and-library/2.webp?raw=true)

홈페이지에 명시된 바와 같이 ***Express.js***는 웹 프레임워크이다. ***Node.js***의 견고한 비동기 통신 지원의 장점을 활용하여 가볍고 빠르며, 쉽게 적용 가능한 웹 앱과 REST API를 쓸 수 있다.

## 3. 프레임워크와 라이브러리의 차이점 {#3-framework-vs-library}

### 3-1. 차이점 {#3-1-framework-library-differences}
...
### 3-2. 요약 {#3-2-framework-library-summary}
