...
## 1. 플랫폼 측면 {#1-by-platform}

### 1-1. 윈도우(Windows) 소프트웨어 개발자 {#1-1-windows-software-developer}
...
### 1-2. 웹(Web) 소프트웨어 개발자 {#1-2-web-software-developer}
...
### 1-3. 앱(App) 소프트웨어 개발자 {#1-3-app-software-developer}
...
### 1-4. 시스템 소프트웨어(임베디드) 개발자 {#1-4-system-embedded-software-developer}
...
### 1-5. 게임 소프트웨어 개발자 {#1-5-game-software-developer}
...
## 2. 업무환경 측면 {#2-by-work-environment}

### 2-1. 네트워크 소프트웨어 개발자 {#2-1-network-software-developer}
...
### 2-2. 데이터베이스 소프트웨어 개발자 {#2-2-database-software-developer}
...
### 2-3. 솔루션(제품) 소프트웨어 개발자 {#2-3-solution-product-software-developer}
...
### 2-4. 공통업무 소프트웨어 개발자 {#2-4-common-business-software-developer}
...
### 2-5. AI(인공지능) 소프트웨어 개발자 {#2-5-ai-software-developer}
...
### 2-6. 블록체인(Block Chain) 개발자 {#2-6-blockchain-developer}
...
### 2-7. SAP ABAP 소프트웨어 개발자 {#2-7-sap-abap-software-developer}
